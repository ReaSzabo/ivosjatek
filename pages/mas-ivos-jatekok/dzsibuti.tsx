...
export default function DjiboutiPage() {
    return (
        <>
            <SeoMeta
                canonical="https://ivosjatek.hu/mas-ivos-jatekok/dzsibuti"
                title="Djibouti - Számolós ivós játék, nagy társaságnak"
                description="Számolós ivós játék, ahol a hetes és annak többszörösei helyett 'Dzsibuti'-t kell mondani. Aki hibázik, iszik. Nagy társasággal ajánlott! Ez a játék garantáltan megnevetteti a résztvevőket, és izgalmas kihívást jelent minden buliban, ahol sokan vagytok!"
            />
            <OtherGame
                title="Djibouti"
