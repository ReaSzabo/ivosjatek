...
export default function UnflinchingFacePage() {
    return (
        <>
            <SeoMeta
                canonical="https://ivosjatek.hu/mas-ivos-jatekok/rezzenestelen-arc"
                title="Rezzenéstelen arc - Ivós játék, vicces kihívásokkal"
                description="Ivós játék, ahol vicces mondatokat kell rezzenéstelen arccal kibírni. Aki elneveti magát vagy reagál, iszik! Ez a játék garantáltan megnevetteti a társaságot, és vicces pillanatokat hoz minden baráti összejövetelre!"
            />
            <OtherGame
